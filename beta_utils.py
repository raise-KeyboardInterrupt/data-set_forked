...
from threshold_utils import find_threshold_at_fixed_current, _current_sd_from_ratio
...
def load_iv_file(
    ...
    threshold_utils._current_sd_from_ratio.
    """
...
def fit_avalanche_beta(
    ...
    V_th, I_th, _, _ = find_threshold_at_fixed_current(
        filename,
